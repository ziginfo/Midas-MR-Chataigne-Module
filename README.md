...
And there is a new feature that allows to send values directly from the "Channels-Container" to the console, for example after changing a value in the Channel Filed in Chataigne!
Pleas be extremely careful with this feature; as you may erase settings and value on the console !! for example if you hit "SEND" before having any datas and values in the fields, which is a sort of "RESET"
